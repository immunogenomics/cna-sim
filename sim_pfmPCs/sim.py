...
phenotype_names = ["causal_PFM_PC" + s for s in sim_pcs.astype("str")]

for i_phenotype in np.arange(n_phenotypes):
    n_pc = sim_pcs[i_phenotype]
    data.obs[phenotype_names[i_phenotype]] = data.uns['sampleXnh_featureXpc'][:,i_phenotype]
    sampleXmeta[phenotype_names[i_phenotype]] = data.uns['sampleXnh_sampleXpc'][:,i_phenotype]
